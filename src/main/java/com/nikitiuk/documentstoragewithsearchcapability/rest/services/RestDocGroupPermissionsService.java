...
public class RestDocGroupPermissionsService {
    ...
    public Response showPermissionsForDocumentsByGroupId(long groupId) {
        ...
        try {
            ...
            return ResponseService.errorResponse(404, "Error while producing permissions for documents for group.");
        }
    ...
    public Response showAllGroupPermissionsForDocuments() {
        ...
        try {
            ...
            return ResponseService.errorResponse(404, "Error while producing all permissions for documents for every group.");
        }
        final Context ctx = new Context();
        ctx.setVariable("entityName", "DocGroupPermissions");
        ctx.setVariable("inStorage", docGroupPermissionsList);
    ...
    public Response setWriteForDocumentForGroup(DocGroupPermissionsRequest requestObj) {
        if (checkIfRequestJsonHasNulls(requestObj)) {
            return ResponseService.errorResponse(404, "No ids were passed.");
        }
        try {
            ...
            return ResponseService.errorResponse(404, "Error while setting write permissions for document for group.");
        }
    ...
    public Response setReadForDocumentForGroup(DocGroupPermissionsRequest requestObj) {
        ...
        try {
            ...
            logger.error("Error at setWritePermissionsForDocumentForGroup: ", e);
            return ResponseService.errorResponse(404, "Error while setting read permissions for document for group.");
        }
        return ResponseService.okResponseSimple("Permissions set successfully");
    }
    ...
    public Response deleteAllPermissionsForGroup(long groupId) {
        try {
            ...
            return ResponseService.errorResponse(404, "Error while deleting all permissions for documents for group.");
        }
    ...
    public Response deleteAllPermissionsForDocumentExceptAdmin(long documentId) {
        try {
            ...
            DocBean checkedDocBean = docDao.getOneById(documentId);
            ...
            return ResponseService.errorResponse(404, "Error while deleting all permissions for document.");
        }
    ...
    public Response deletePermissionsForDocumentForGroup(DocGroupPermissionsRequest requestObj) {
        ...
        try {
            DocDao docDao = new DocDao();
            GroupDao groupDao = new GroupDao();
            DocBean checkedDocBean = docDao.getOneById(requestObj.getDocumentId());
            GroupBean checkedGroupBean = groupDao.getOneById(requestObj.getGroupId());
            ...
            return ResponseService.errorResponse(404, "Error while deleting permissions for document for group.");
        }
