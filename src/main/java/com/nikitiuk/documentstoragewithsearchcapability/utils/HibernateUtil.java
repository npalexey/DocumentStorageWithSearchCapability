...
public class HibernateUtil {
    ...
    public static SessionFactory getSessionFactory() {
        if (sessionFactory == null) {
            try {
                ...
                settings.put(Environment.URL, "jdbc:mysql://localhost:3306/document_tracker?useSSL=false");
    ...
    private static void populateTable(SessionFactory sessionFactory) throws Exception{
        DocDao.populateTableWithDocs(LocalStorageService.getDocsInPath(), sessionFactory.openSession());
    }
}
